...
@ApplicationScoped
public class UserStatusChangerRule implements ServiceRule {
    @Inject
    UserService userService;

    @Override
    public boolean matches(Object input) {
        return (input.toString().equalsIgnoreCase(RequestTypes.CHANGE_USER_STATUS.name()));
    }
    ...
    public JSONObject apply(Object input) {
        ...
        ServiceResponder response=userService.changeUserStatus(request);
